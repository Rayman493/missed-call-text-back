...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // Capacitor Push Notifications: forward APNs registration results into the
    // bridge so the JS 'registration' / 'registrationError' listeners fire.
    // Without these, PushNotifications.register() never produces a token.
