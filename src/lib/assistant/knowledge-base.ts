...
It runs in the background so you can focus on the job while still capturing every missed opportunity.`,
  ...
  },
  {
    ...
    answer: 'ReplyFlow is $59/month with a 14-day free trial. No contracts required. You can cancel anytime during the trial with no charge. Billing is managed through the Stripe portal accessible from Dashboard → Settings → Subscription, or in Google Play under Payments & subscriptions on Android.',
    category: 'Billing',
    source: 'Pricing Page',
  ...
  },
  {
    ...
    answer: 'No. The 14-day trial is free with no charge. You\'ll only be charged after the trial ends if you choose to continue. Billing is managed through Stripe — or Google Play on Android. You can cancel anytime during the trial via Dashboard → Settings → Subscription.',
    category: 'Billing',
    source: 'Beta FAQ',
  ...
  },
  {
    ...
    answer: 'Go to Dashboard → Settings → Subscription and use the billing management option — the Stripe portal on web, or the Play Store under Payments & subscriptions on Android. You can cancel anytime during the 14-day trial with no charge. After cancellation, you keep access until the end of the paid period and won\'t be billed further. Uninstalling the app does not cancel a Google Play subscription.',
    category: 'Billing',
    source: 'Beta FAQ',
...
- Troubleshoot call forwarding`,
  ...
  },
  {
    ...
    answer: 'ReplyFlow offers a 14-day free trial with no charge. After the trial ends, you\'ll be charged $59/month if you choose to continue. You can cancel anytime before the trial ends with no charge. Billing is handled through Stripe — or Google Play on Android. View your subscription status in Dashboard → Settings → Subscription.',
    category: 'Billing',
