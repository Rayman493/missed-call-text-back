...
export const CUSTOMER_STATUS_STYLES: Record<CustomerStatus, CustomerStatusStyle> = {
  new: {
    label: 'New',
    cardClass: 'border-blue-400/50 bg-gradient-to-br from-blue-50 via-blue-50/60 to-card dark:from-blue-500/25 dark:via-blue-500/12 dark:to-slate-900/95 shadow-sm dark:shadow-[0_0_20px_rgba(59,130,246,0.10)]',
  ...
  needs_reply: {
    label: 'Needs Reply',
    cardClass: 'border-cyan-400/50 bg-gradient-to-br from-cyan-50 via-cyan-50/60 to-card dark:from-cyan-500/25 dark:via-cyan-500/12 dark:to-slate-900/95 shadow-sm dark:shadow-[0_0_20px_rgba(6,182,212,0.10)]',
  ...
  active: {
    label: 'Active',
    cardClass: 'border-green-400/50 bg-gradient-to-br from-green-50 via-green-50/60 to-card dark:from-green-500/25 dark:via-green-500/12 dark:to-slate-900/95 shadow-sm dark:shadow-[0_0_20px_rgba(34,197,94,0.10)]',
  ...
  scheduled: {
    label: 'Scheduled',
    cardClass: 'border-purple-400/50 bg-gradient-to-br from-purple-50 via-purple-50/60 to-card dark:from-purple-500/25 dark:via-purple-500/12 dark:to-slate-900/95 shadow-sm dark:shadow-[0_0_20px_rgba(168,85,247,0.10)]',
  ...
  payment_requested: {
    ...
    cardClass: 'border-amber-400/50 bg-gradient-to-br from-amber-50 via-amber-50/60 to-card dark:from-amber-500/25 dark:via-amber-500/12 dark:to-slate-900/95 shadow-sm dark:shadow-[0_0_20px_rgba(245,158,11,0.10)]',
  ...
  paid: {
    label: 'Paid',
    cardClass: 'border-emerald-400/50 bg-gradient-to-br from-emerald-50 via-emerald-50/60 to-card dark:from-emerald-500/25 dark:via-emerald-500/12 dark:to-slate-900/95 shadow-sm dark:shadow-[0_0_20px_rgba(16,185,129,0.10)]',
  ...
  completed: {
    label: 'Completed',
    cardClass: 'border-slate-300/50 bg-gradient-to-br from-slate-50 via-slate-50/60 to-card dark:from-slate-400/25 dark:via-slate-400/12 dark:to-slate-900/95 shadow-sm dark:shadow-[0_0_20px_rgba(148,163,184,0.10)]',
  ...
  ignored: {
    label: 'Ignored',
    cardClass: 'border-orange-400/50 bg-gradient-to-br from-orange-50 via-orange-50/60 to-card dark:from-orange-500/25 dark:via-orange-500/12 dark:to-slate-900/95 shadow-sm dark:shadow-[0_0_20px_rgba(249,115,22,0.10)]',
  ...
  lost: {
    label: 'Lost',
    cardClass: 'border-red-400/50 bg-gradient-to-br from-red-50 via-red-50/60 to-card dark:from-red-500/25 dark:via-red-500/12 dark:to-slate-900/95 shadow-sm dark:shadow-[0_0_20px_rgba(239,68,68,0.10)]',
