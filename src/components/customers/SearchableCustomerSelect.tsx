          ...
          <div className="p-3 border-b border-border/20">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-9 pr-3 py-2 text-sm bg-muted/50 border border-border/50 rounded-lg text-foreground placeholder-muted-foreground focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/80"
              />
            </div>
          </div>
