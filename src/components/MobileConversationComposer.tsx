...
export default function MobileConversationComposer({ 
  ...
  return (
    <div className="border-t border-border bg-card/95 backdrop-blur-md p-3 sm:p-4 lg:p-5 pb-4 sm:pb-6 sticky bottom-0 z-50" style={{ paddingBottom: 'max(16px, env(safe-area-inset-bottom))' }}>
