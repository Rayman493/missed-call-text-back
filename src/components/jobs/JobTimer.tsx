      ...
      <div className="flex items-center gap-3 mb-2">
        ...
        {activeEntry && (
          <div className="flex items-center gap-2 ml-auto">
            <span className="text-[10px] font-medium text-amber-600 dark:text-amber-400 animate-pulse">Running</span>
      ...
      {entries.length > 0 && (
        <div className="mt-3 pt-3 border-t border-slate-100 dark:border-slate-700/50 space-y-2">
          {entries.map((entry) => {
            ...
            if (isEditing) {
              return (
                <div key={entry.id} className="p-2 rounded bg-white dark:bg-slate-800 border border-border/50 space-y-2">
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full text-xs px-2 py-1 rounded border border-border/50 bg-background text-foreground"
                      />
                    </div>
                    <div>
            ...
            if (isDeleteConfirm) {
              return (
                <div key={entry.id} className="p-2 rounded bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800/50 flex items-center gap-2">
                  <span className="text-[10px] text-red-700 dark:text-red-300 flex-1">Delete this entry?</span>
                  <button
                  ...
                  <button
                    ...
                    className="text-[10px] font-medium px-2 py-1 text-muted-foreground hover:text-foreground rounded transition-colors"
                  >
                    Cancel
                  </button>
                </div>
