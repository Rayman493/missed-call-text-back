  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-4">
        <div className="bg-card rounded-2xl shadow-2xl shadow-black/10 dark:shadow-black/30 border border-border/50 w-full max-w-lg max-h-[var(--modal-max-height)] sm:max-h-[90vh] overflow-hidden flex flex-col animate-in zoom-in-95 duration-200">
          {/* Header */}
