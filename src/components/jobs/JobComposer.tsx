  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-[60] flex items-end sm:items-center justify-center p-0 sm:p-4 pb-[calc(var(--bottom-nav-height,72px)+env(safe-area-inset-bottom)+16px)] sm:pb-4" data-scroll-lock-allow>
        <div className="relative bg-white dark:bg-slate-900 rounded-t-2xl sm:rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 w-full max-w-lg h-[min(82dvh,calc(100dvh-6rem-env(safe-area-inset-bottom)))] sm:h-auto sm:max-h-[90vh] flex flex-col overflow-hidden">
          {/* Header */}
