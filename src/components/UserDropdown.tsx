      ...
      {isValidSession && user ? (
        <>
          <button
            ...
            className="flex items-center gap-2.5 px-3 py-3 text-sm font-medium text-gray-300 hover:text-white rounded-md hover:bg-white/10 transition-colors"
          >
            <svg className="w-6.5 h-6.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
            <span className="text-base font-bold hidden sm:inline">Account</span>
