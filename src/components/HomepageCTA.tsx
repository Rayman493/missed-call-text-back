    ...
    return (
      <div className="flex flex-col items-center gap-3 sm:gap-4">
        {isLoggedIn ? (
          <Link
            href="/dashboard"
            className="inline-flex items-center justify-center h-14 sm:h-16 px-6 sm:px-10 w-[85%] max-w-[320px] mx-auto sm:w-auto sm:max-w-none sm:min-w-[280px] bg-blue-600 text-white font-bold text-sm sm:text-base rounded-xl shadow-lg hover:bg-blue-700 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            Go to Dashboard
          </Link>
        ) : (
