...
import { MessageCircle, ChevronDown, ChevronUp, X, Check, Loader2, User, Pencil, MapPin, Calendar, Phone, Clock, Info } from 'lucide-react'
...
export default function AICallDetails({ leadId, businessId, conversationId, callerPhone, leadData, collapsible = true, onSave, onNavigateToTimeline, triggerEdit }: AICallDetailsProps) {
  ...
  return (
    <div className="space-y-4">
              ...
              <div className="flex flex-col min-w-0 flex-1">
                ...
                {!summaryExpanded && conciseTitle && (
                  <p className="text-[10px] font-medium text-foreground/80 leading-tight truncate">
                    {capitalizeFirstAlpha(conciseTitle)}
                  </p>
                )}
              </div>
      ...
      {/* Call Transcript - Word-for-word conversation (shared component,
          also used by the desktop customer-context sidebar) */}
      <CallTranscriptCard transcript={normalizedTranscript} />
