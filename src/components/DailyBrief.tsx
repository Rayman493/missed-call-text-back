...
import { AlertCircle, DollarSign, Calendar, Users, Activity, ChevronDown, ChevronUp } from 'lucide-react'
    ...
    <div className="px-5 py-3">
      ...
      >
        <div className="flex items-center gap-3">
          <div className={`w-8 h-8 rounded-lg flex items-center justify-center ${getSectionIconBg(section.type)}`}>
            {icon}
          </div>
...
function BriefItem({ item }: BriefItemProps) {
  ...
  return (
    <div className="flex items-start gap-2">
      <div className={`w-1.5 h-1.5 rounded-full mt-1.5 ${priorityColor}`} />
