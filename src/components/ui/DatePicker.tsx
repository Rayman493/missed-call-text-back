    ...
    <div className="relative">
      ...
      <div className="relative min-w-0">
        <input
          ...
          className={`w-full min-w-0 px-3 py-2.5 text-base sm:text-sm leading-5 border rounded-lg duration-150 appearance-none hide-native-picker min-h-11 pr-12 ${
            disabled
          ...
          <div className="absolute right-1.5 top-1/2 -translate-y-1/2 w-9 h-9 flex items-center justify-center pointer-events-none">
            {value ? (
              <button
                type="button"
                onClick={clearDate}
                className="w-9 h-9 flex items-center justify-center hover:bg-accent/40 rounded duration-150 pointer-events-auto z-10"
