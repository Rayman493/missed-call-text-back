...
export default function TapToPayModal({
  ...
  return (
    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-3 sm:p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
  ...
  if (showReceiptModal && typeof document !== 'undefined') {
    return createPortal(
      <div className="fixed inset-0 z-[80] flex items-center justify-center p-3 sm:p-4 bg-black/50 backdrop-blur-sm animate-in fade-in duration-200">
