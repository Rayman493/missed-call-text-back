...
export default function AppHeader({
  ...
  return (
    <header className="sticky top-0 z-50 bg-slate-900 dark:bg-slate-800 flex-shrink-0 shadow-none border-b-0">
      <div className="max-w-7xl mx-auto pl-3 pr-3 sm:px-6 lg:px-8 py-2.5">
