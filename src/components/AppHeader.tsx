...
export default function AppHeader({
  ...
  return (
    <>
      <header className="sticky top-0 z-50 flex-shrink-0 border-b border-white/10 bg-slate-950 shadow-[0_1px_0_rgba(255,255,255,0.06),0_18px_52px_rgba(2,6,23,0.34)]" style={{ paddingTop: 'env(safe-area-inset-top)' }}>
