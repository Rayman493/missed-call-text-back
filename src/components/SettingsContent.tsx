        ...
        <div className="min-h-screen bg-background dark:bg-background flex flex-col relative">
          ...
          <AppHeader title="Settings" />
            ...
            <div className="space-y-2.5 sm:space-y-3.5 pb-40">
              ...
              {/* Automation Settings */}
              <div id="automation" className="bg-white dark:bg-slate-900/60 backdrop-blur-sm rounded-xl border border-slate-200/70 dark:border-slate-700/50 shadow-sm hover:shadow-md transition-all duration-200 p-4 sm:p-6 scroll-mt-24">
              ...
              <div id="integrations" className="bg-white dark:bg-slate-900/60 backdrop-blur-sm rounded-xl border border-slate-200/70 dark:border-slate-700/50 shadow-sm hover:shadow-md transition-all duration-200 p-4 sm:p-6 scroll-mt-24">
                <h2 className="text-base sm:text-lg font-semibold text-slate-900 dark:text-foreground mb-1">Integrations</h2>
                <p className="text-xs sm:text-sm text-slate-600 dark:text-muted-foreground mb-4">Connect third-party services to extend ReplyFlow's capabilities.</p>
                
                {/* Google Calendar Card */}
                <div className="p-4 sm:p-5 bg-slate-50/80 dark:bg-slate-800/40 rounded-lg border border-slate-200/60 dark:border-slate-700/40">
                  <div className="flex items-start justify-between mb-3 sm:mb-4">
                    <div className="flex-1 pr-4">
                      <div className="flex items-center gap-2.5 mb-1.5 sm:mb-2">
                        ...
                        <h3 className="text-sm sm:text-base font-semibold text-slate-900 dark:text-foreground">Google Calendar</h3>
                        {calendarConnected && (
                          <span className="text-[10px] sm:text-xs px-2 py-0.5 bg-green-500/10 text-green-600 dark:text-green-400 rounded-full font-medium flex items-center gap-1">
                            <span className="w-1 h-1 bg-green-500 rounded-full animate-pulse" />
                            Connected
                      ...
                      <p className="text-xs sm:text-sm text-slate-600 dark:text-muted-foreground mb-1.5 sm:mb-2">
                        Connect your Google Calendar to schedule follow-ups and appointments.
                      </p>
                      <div className="text-[10px] sm:text-xs text-slate-600 dark:text-muted-foreground">
                        📅 Allows ReplyFlow to create calendar events for scheduled follow-ups.
                      </div>
                    </div>
                    {!isLoadingCalendar && (
                      <button
                        ...
                        className={`flex-shrink-0 px-3 py-1.5 sm:px-4 sm:py-2 text-xs sm:text-sm font-medium rounded-lg transition-all hover:scale-105 active:scale-95 disabled:opacity-50 disabled:hover:scale-100 ${
                          calendarConnected
              ...
              <div id="contacts" className="bg-card rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 border border-border/60 p-4 sm:p-6 scroll-mt-24">
