      ...
      <BusinessGuard>
        <div className="min-h-screen bg-background dark:bg-background flex flex-col relative">
          ...
          <AppHeader title="Settings" />
            ...
            <div className="sticky top-[80px] z-40 bg-background/95 dark:bg-background/95 backdrop-blur-sm border-b border-slate-200 dark:border-slate-800 shadow-sm pb-4 sm:pb-5 md:pb-6 mb-4 sm:mb-6 md:mb-8">
              {/* Page Header */}
