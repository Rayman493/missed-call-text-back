  ...
  return (
    <div className="bg-card rounded-xl shadow-sm border border-border p-6 hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 sm:p-6 mb-6">
        <p className="text-sm text-muted-foreground mb-2">Your ReplyFlow number:</p>
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        <button
          ...
          className="flex-1 px-6 py-3 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-800 text-white font-medium rounded-lg transition-colors text-sm sm:text-base"
        >
