...
export default function RevenueOpportunities({ business }: RevenueOpportunitiesProps) {
  ...
  if (loading) {
    return (
      <div className="bg-white dark:bg-slate-900/60 card-border dark:border-slate-700/50 rounded-2xl p-4 sm:p-5 shadow-sm">
  ...
  return (
    <div className="bg-white dark:bg-slate-900/60 card-border dark:border-slate-700/50 rounded-2xl shadow-sm">
      {/* Header */}
      <div className="px-4 sm:px-5 py-3 border-b border-border/20 dark:border-border/10">
      ...
      {/* Content */}
      <div className="divide-y divide-border/20 dark:border-border/10">
        {opportunities.length === 0 ? (
