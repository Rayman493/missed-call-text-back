...
export default function BackToTopButton({ lifted = false }: BackToTopButtonProps) {
  ...
  const position = lifted
    ...
    : 'bottom-[calc(env(safe-area-inset-bottom,0px)+var(--bottom-nav-height,0px)+1rem)] sm:bottom-6'
