...
export default function SetupHealth() {
  ...
  if (loading || !business) {
    return (
      <div className="bg-white dark:bg-card rounded-xl shadow-sm border border-slate-200/80 dark:border-border/40 p-6">
...
return (
  <div className="bg-white dark:bg-card rounded-xl shadow-sm border border-slate-200/80 dark:border-border/40 overflow-hidden">
