...
export default function EmptyStateGuidance({ 
  ...
  return (
    <div className="bg-gradient-to-br from-blue-900/20 to-indigo-900/20 border border-blue-800 rounded-xl p-6 sm:p-8">
      ...
      <div className="space-y-4 mb-6">
        {content.steps.map((step, index) => (
          <div key={index} className="flex items-start gap-4">
            <div className="flex-shrink-0 w-8 h-8 bg-slate-800 rounded-full flex items-center justify-center border border-blue-800">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-slate-800 hover:bg-slate-700 text-foreground text-sm font-medium rounded-lg border border-border transition-colors"
        >
