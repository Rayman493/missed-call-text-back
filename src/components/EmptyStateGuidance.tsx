    ...
    <div className="bg-gradient-to-br from-primary/10 to-primary/5 border border-border/50 rounded-2xl p-6 sm:p-8">
      ...
      <div className="space-y-4 mb-6">
        {content.steps.map((step, index) => (
          <div key={index} className="flex items-start gap-4">
            <div className="flex-shrink-0 w-8 h-8 bg-muted rounded-full flex items-center justify-center border border-border/50">
      ...
      <div className="flex flex-col sm:flex-row gap-3 justify-center">
        {onTestSetup ? (
          <button
            onClick={onTestSetup}
            className="inline-flex items-center gap-2 px-4 py-2 bg-primary hover:bg-primary/90 text-primary-foreground text-sm font-medium rounded-lg transition-colors duration-200"
          >
        ...
        <Link
          ...
          className="inline-flex items-center gap-2 px-4 py-2 bg-muted hover:bg-muted/80 text-foreground text-sm font-medium rounded-lg border border-border/50 transition-colors duration-200"
        >
