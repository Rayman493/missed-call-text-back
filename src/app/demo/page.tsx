...
export default function DemoPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      {/* Demo Mode Banner */}
      <div className="bg-yellow-100 border-b border-yellow-200 px-4 py-3 text-center">
        ...
        <div className="mb-12">
          ...
          <div className="space-y-4">
            {sampleLeads.map((lead) => (
              <div key={lead.id} className="bg-white rounded-lg p-4 hover:bg-gray-50 transition-colors duration-200 border border-gray-200 shadow-sm">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-semibold text-gray-900 truncate">{formatPhoneNumber(lead.caller_phone)}</p>
                        <p className="text-sm text-gray-500">{formatRelativeTime(lead.last_activity)}</p>
                      </div>
                    </div>
                    {/* Message Thread */}
