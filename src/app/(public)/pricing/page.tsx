...
export const metadata: Metadata = {
  title: 'ReplyFlow Pricing | AI Voice, Customer Management, Payments & Quotes',
  description: 'ReplyFlow pricing: $59/month with a 14-day free trial. AI Voice, missed-call recovery, customer management, appointment scheduling, Payment Requests, and quotes & invoices for local businesses. Cancel anytime.',
}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              AI Voice, customer management, appointment scheduling, Payment Requests, and quotes & invoices — one flat monthly price.
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start">
                      ...
                      <span className="text-slate-700 dark:text-slate-300">Quotes & invoices sent via SMS with PDF</span>
                    </div>
