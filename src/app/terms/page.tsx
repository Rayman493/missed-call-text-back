            ...
            <div className="bg-card rounded-2xl shadow-sm border border-border overflow-hidden">
              <div className="p-8">
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none">
                  ...
                  <div className="mt-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-muted-foreground">
                          <strong>AI Accuracy</strong> - AI-generated responses may occasionally contain inaccuracies or errors
                        </p>
                      </div>
                      <div className="flex items-start gap-3">
                        <svg className="w-5 h-5 text-amber-600 dark:text-amber-400 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <p className="text-muted-foreground">
                          <strong>Review Responsibility</strong> - Businesses remain responsible for reviewing important customer communications
                        </p>
                      </div>
                      <div className="flex items-start gap-3">
                        <svg className="w-5 h-5 text-amber-600 dark:text-amber-400 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <p className="text-muted-foreground">
                          <strong>Legal Compliance</strong> - Businesses are responsible for complying with applicable laws governing call handling, call recording, messaging, and customer communications
                        </p>
                      </div>
                    </div>
                  </div>
                  <div className="mt-6 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg">
                    <p className="text-sm text-amber-800 dark:text-amber-200">
                      <strong>Important:</strong> ReplyFlow's AI features are designed to assist with customer communications but do not replace professional judgment or legal compliance requirements.
                    </p>
                  </div>
                </div>
              </div>
