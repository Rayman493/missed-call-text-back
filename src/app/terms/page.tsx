              ...
              <div className="p-8">
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none">
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Subscription Fees</h3>
                      <p className="text-gray-600 dark:text-gray-400">
                        ReplyFlowHQ services are provided on a subscription basis with monthly recurring fees.
                      </p>
                    </div>
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Billing Cycle</h3>
                      <p className="text-gray-600 dark:text-gray-400">
                        Fees are billed in advance on a monthly basis. No refunds for partial months.
                      </p>
                    </div>
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Payment Methods</h3>
                      <p className="text-gray-600 dark:text-gray-400">
                        We accept major credit cards and other payment methods as specified during signup.
                      </p>
                    </div>
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Late Payments</h3>
                      <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
              <div className="p-8">
                ...
                <div className="prose prose-gray dark:prose-invert max-w-none">
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">User Termination</h3>
                      <p className="text-gray-600 dark:text-gray-400">
                        You may terminate your account at any time through your dashboard settings or by contacting support.
                      </p>
                    </div>
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">ReplyFlowHQ Termination</h3>
                      <p className="text-gray-600 dark:text-gray-400">
                        We may terminate service for violations of these terms or non-payment with appropriate notice.
                      </p>
                    </div>
                    <div>
                      <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">Data Retention</h3>
                      <p className="text-gray-600 dark:text-gray-400">
