      ...
      <BusinessGuard>
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900/30 flex flex-col">
          ...
          <div className="flex-1 p-4 sm:p-6 lg:p-8 pb-24">
            ...
            {/* Setup Health Banner - Show when forwarding not enabled AND user has valid subscription */}
            {business?.onboarding_status === 'completed' && !business?.call_forwarding_enabled && hasValidSubscription(business?.subscription_status, business?.stripe_customer_id, business?.stripe_subscription_id) && (
