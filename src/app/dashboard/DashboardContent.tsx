            ...
            <div className="flex-1 pt-1.5 sm:pt-2 lg:pt-2 px-3 sm:px-4 lg:px-6 pb-12 relative z-10">
              <div className="max-w-[1400px] mx-auto space-y-1 sm:space-y-1.5">
                ...
                {hasActiveSubscription(business) ? (
                  <>
                    {/* Dashboard Lock: Blur content when forwarding is not verified */}
                    {!business?.forwarding_verified && (
                      <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-40 flex items-center justify-center pointer-events-none">
                        <div className="bg-card border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-xl max-w-md mx-4">
                          <div className="text-center">
                            ...
                            <h3 className="text-lg font-semibold text-foreground mb-2">Complete setup to unlock dashboard</h3>
                            <p className="text-muted-foreground text-sm">Finish the call forwarding setup above to access your dashboard features.</p>
                          </div>
                        </div>
                      </div>
                    )}

                    <div className={business?.forwarding_verified ? '' : 'blur-sm opacity-50 pointer-events-none select-none'}>
