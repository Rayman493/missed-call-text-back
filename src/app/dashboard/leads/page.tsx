                ...
                <DropdownMenu open={filterMenuOpen} onOpenChange={(open) => {
                  ...
                  <DropdownMenuTrigger asChild>
                    <button
                      ...
                      className={`h-10 px-3 inline-flex items-center justify-center gap-2 border border-border/50 rounded-lg text-sm font-medium transition-all whitespace-nowrap
                        focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/20 focus-visible:border-primary/40
                        data-[state=open]:bg-muted/50 data-[state=open]:text-foreground
                        ${(quickFilter !== 'all' || statusFilter !== 'all')
                          ? 'bg-primary/10 text-primary border-primary/30'
                          : 'bg-background text-muted-foreground hover:text-foreground hover:bg-muted/50 active:bg-background'
                        }`}
