    ...
    <DashboardErrorBoundary>
      ...
      <BusinessGuard>
        <div className="min-h-screen bg-background page-gradient flex flex-col relative overflow-x-hidden">
          ...
          {/* Main Content */}
          <main className="flex-1 pt-6 sm:pt-8 lg:pt-10 px-4 sm:px-5 lg:px-7 md:pb-10 relative z-10 overflow-y-auto" style={{ paddingBottom: 'calc(var(--bottom-nav-height, 80px) + 16px)' }}>
