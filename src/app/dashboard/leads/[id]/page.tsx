              ...
              <div className="flex items-center gap-1.5 flex-shrink-0">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuPortal>
                    ...
                    >
                      {/* TEMP DEBUG: Remove after root cause is fixed */}
                      <div className="px-3 py-2 text-[11px] text-foreground bg-amber-500/10 border-b border-border/30">
                        <div><strong>isNativeApp:</strong> {String(isNativeApp)}</div>
                        <div><strong>phoneRaw:</strong> {customerPhoneRaw || '(empty)'}</div>
                        <div><strong>dialNumber:</strong> {dialNumber || '(empty)'}</div>
                        <div><strong>digitCount:</strong> {digitCount}</div>
                        <div><strong>canDialPhone:</strong> {String(canDialPhone)}</div>
                      </div>
                      ...
                      <div className="px-2 py-3">
                        ...
                        {/* TEMP: Render unconditionally to prove menu code path is live. Remove guard after fix. */}
                        <DropdownMenuItem
