...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    // Customer confirmation SMS is intentionally not sent automatically on creation.
    // Users can explicitly send appointment details via the Text Details action.
