...
export default function OnboardingPage() {
  ...
  useEffect(() => {
    ...
    const getUser = async () => {
      ...
      if (existingBusiness && !existingError) {
        ...
        console.error('[Onboarding] Error checking existing business:', existingError)
      }
    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-foreground text-lg">Setting up your account...</p>
          <p className="text-muted-foreground text-sm mt-2">Please wait while we prepare your workspace</p>
        </div>
      </div>
    )
  }
  ...
  if (provisioningComplete) {
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center">
          <div className="w-8 h-8 border-4 border-green-600 dark:border-green-500 border-t-transparent border-solid animate-spin rounded-full mx-auto mb-4"></div>
          <p className="text-foreground text-lg">Setting up your dedicated ReplyFlow number...</p>
          <p className="text-muted-foreground text-sm mt-2">Almost there!</p>
        </div>
      </div>
    )
  }
