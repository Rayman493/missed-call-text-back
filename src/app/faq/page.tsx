  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <div className="mt-4 space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">No cold texting or purchased contact lists</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-600 dark:text-slate-400">Messages only occur after inbound customer calls</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-600 dark:text-slate-400">Pure conversational customer communication</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-green-600 dark:text-green-400" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-600 dark:text-slate-400">Customer-initiated contact triggers every message</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <div className="mt-4 space-y-3">
                  <div className="bg-slate-100 dark:bg-slate-800 rounded-2xl p-4">
                    <p className="font-mono text-sm text-slate-900 dark:text-white mb-2">STOP</p>
                    <p className="text-slate-600 dark:text-slate-400">
                      Customers can reply "STOP" to immediately opt out of all future messages
                    </p>
                  </div>
                  <div className="bg-slate-100 dark:bg-slate-800 rounded-2xl p-4">
                    <p className="font-mono text-sm text-slate-900 dark:text-white mb-2">HELP</p>
                    <p className="text-slate-600 dark:text-slate-400">
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <div className="mt-4 space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">Customers continue calling your published business number</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                    </svg>
                    <span className="text-slate-600 dark:text-slate-400">Missed calls forward to ReplyFlow infrastructure</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">ReplyFlow handles the automated text response</span>
                  </div>
                </div>
                <p className="text-slate-600 dark:text-slate-400 mt-4">
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <div className="mt-4 space-y-3">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">Real-time conversation inbox in your dashboard</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z" />
                    </svg>
                    <span className="text-slate-600 dark:text-slate-400">Instant notifications for new customer messages</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-blue-600 dark:text-blue-400" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    <span className="text-slate-600 dark:text-slate-400">Message history and conversation tracking</span>
                  </div>
                </div>
                <p className="text-slate-600 dark:text-slate-400 mt-4">
              ...
              <div className="prose prose-invert max-w-none">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
                  <div className="bg-slate-100 dark:bg-slate-800 rounded-2xl p-4 border border-slate-200 dark:border-slate-700">
                    <h4 className="font-semibold text-slate-900 dark:text-white mb-1">Verizon</h4>
                    <p className="text-slate-600 dark:text-slate-400 text-sm">Dial <code className="bg-slate-200 dark:bg-slate-700 px-2 py-1 rounded text-slate-900 dark:text-white font-mono">*73</code> from your business phone.</p>
                  </div>

                  <div className="bg-slate-100 dark:bg-slate-800 rounded-2xl p-4 border border-slate-200 dark:border-slate-700">
                    <h4 className="font-semibold text-slate-900 dark:text-white mb-1">AT&T</h4>
                    <p className="text-slate-600 dark:text-slate-400 text-sm">Dial <code className="bg-slate-200 dark:bg-slate-700 px-2 py-1 rounded text-slate-900 dark:text-white font-mono">##004#</code> from your business phone.</p>
                  </div>

                  <div className="bg-slate-100 dark:bg-slate-800 rounded-2xl p-4 border border-slate-200 dark:border-slate-700">
                    <h4 className="font-semibold text-slate-900 dark:text-white mb-1">T-Mobile</h4>
                    <p className="text-slate-600 dark:text-slate-400 text-sm">Dial <code className="bg-slate-200 dark:bg-slate-700 px-2 py-1 rounded text-slate-900 dark:text-white font-mono">##004#</code> from your business phone.</p>
                  </div>

                  <div className="bg-slate-100 dark:bg-slate-800 rounded-2xl p-4 border border-slate-200 dark:border-slate-700">
                    <h4 className="font-semibold text-slate-900 dark:text-white mb-1">Comcast/Xfinity</h4>
                    <p className="text-slate-600 dark:text-slate-400 text-sm">Dial <code className="bg-slate-200 dark:bg-slate-700 px-2 py-1 rounded text-slate-900 dark:text-white font-mono">*73</code> from your business phone.</p>
                  </div>
                </div>
        ...
        {/* Contact Section */}
        <div className="mt-16 text-center bg-white dark:bg-slate-900 rounded-2xl p-8 border border-slate-200 dark:border-slate-700">
