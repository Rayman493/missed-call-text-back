...
// Dark-styled footer specifically for homepage
    ...
    <footer className="bg-gray-900 border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Product */}
          <div>
            <h3 className="text-sm font-semibold text-gray-100 mb-4">Product</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/#features" className="text-gray-400 hover:text-gray-300 text-sm transition-colors">
                  Features
                </Link>
              </li>
              <li>
                <Link href="/demo" className="text-gray-400 hover:text-gray-300 text-sm transition-colors">
                  Demo
                </Link>
              </li>
              <li>
                <Link href="/pricing" className="text-gray-400 hover:text-gray-300 text-sm transition-colors">
                  Pricing
                </Link>
              </li>
            </ul>
          ...
          {/* Company */}
          <div>
            <h3 className="text-sm font-semibold text-gray-100 mb-4">Company</h3>
            <ul className="space-y-2">
              <li>
                <Link href="/faq" className="text-gray-400 hover:text-gray-300 text-sm transition-colors">
                  FAQ
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/compliance" className="text-gray-400 hover:text-gray-300 text-sm transition-colors">
                  Compliance
                </Link>
              </li>
            </ul>
