                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5">Track every lead in one place</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="flex items-center justify-between p-2.5 bg-slate-50 dark:bg-slate-800 rounded-lg">
                        ...
                        <div className="bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 text-[10px] px-2 py-0.5 rounded font-medium ml-2 flex-shrink-0">New</div>
                      </div>
                      <div className="flex items-center justify-between p-2.5 bg-slate-50 dark:bg-slate-800 rounded-lg">
                        <div className="flex-1 min-w-0">
                        ...
                        <div className="bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-[10px] px-2 py-0.5 rounded font-medium ml-2 flex-shrink-0">Active</div>
                      </div>
                    </div>
                    
                    {/* CTA */}
                    <div className="flex justify-end">
                      <a href="#" className="text-xs text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors">View All Leads →</a>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="p-4 flex flex-col h-full">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5">View every customer conversation in one inbox</p>
                      </div>
                    </div>
                      ...
                      <div className="flex gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-1 mt-1">
                            <div className="text-[10px] text-slate-500 dark:text-slate-500">2m ago</div>
                      ...
                      <div className="flex gap-2">
                        <div className="flex-1 min-w-0 text-right">
                          ...
                          <div className="flex items-center gap-1 mt-1 justify-end">
                            <div className="text-[10px] text-slate-500 dark:text-slate-500">1m ago</div>
                    ...
                    {/* CTA */}
                    <div className="flex justify-end">
                      <a href="#" className="text-xs text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors">Open Inbox →</a>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5">Automatically sync appointments</p>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2 mb-4">
                      <div className="flex items-center gap-3 p-2.5 bg-slate-50 dark:bg-slate-800 rounded-lg">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-xs font-medium text-slate-900 dark:text-foreground truncate">John Smith</div>
                      ...
                      <div className="flex items-center gap-3 p-2.5 bg-slate-50 dark:bg-slate-800 rounded-lg">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="text-xs font-medium text-slate-900 dark:text-foreground truncate">Sarah Johnson</div>
                    ...
                    {/* CTA */}
                    <div className="flex justify-end">
                      <a href="#" className="text-xs text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors">View Calendar →</a>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-600 dark:text-slate-400 mt-0.5">AI captures caller information automatically</p>
                      </div>
                    </div>
                    ...
                    <div className="mb-4">
                      <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-3 space-y-2">
                        ...
                        <div className="flex items-start gap-2">
                          <div className="text-[10px] text-slate-500 dark:text-slate-500 font-medium w-14 flex-shrink-0">Address</div>
                          <div className="text-xs text-slate-900 dark:text-foreground">123 Main St, Apt 4B</div>
                        </div>
                        <div className="flex items-start gap-2">
                          <div className="text-[10px] text-slate-500 dark:text-slate-500 font-medium w-14 flex-shrink-0">Callback</div>
                    ...
                    {/* CTA */}
                    <div className="flex justify-end">
                      <a href="#" className="text-xs text-slate-500 dark:text-slate-400 hover:text-blue-600 dark:hover:text-blue-400 font-medium transition-colors">View Intake →</a>
                    </div>
                  </div>
                </div>
              </div>
