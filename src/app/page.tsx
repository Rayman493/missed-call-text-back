...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 dark:bg-slate-950">
      ...
      {/* Hero Section */}
      <section className="relative flex flex-col items-center justify-center py-20 md:py-28 text-center bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
        <div className="max-w-5xl mx-auto px-6 lg:px-8 space-y-8 relative z-10">
          ...
          >
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                href="/demo"
                className="h-12 px-8 bg-slate-800 dark:bg-slate-800 text-slate-300 dark:text-slate-300 font-semibold rounded-xl border border-slate-600 dark:border-slate-600 hover:bg-slate-700 dark:hover:bg-slate-700 transition-colors flex items-center justify-center"
              >
                View Demo
              </Link>
            </div>
      ...
      <section className="bg-gradient-to-b from-slate-900 to-slate-800 dark:from-slate-900 dark:to-slate-800 py-24 border-t border-slate-800 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="bg-slate-900 dark:bg-slate-900 border border-slate-700 dark:border-slate-700 rounded-2xl shadow-sm p-10 text-center"
            >
              <div className="w-14 h-14 bg-blue-900/30 dark:bg-blue-900/30 border border-blue-800 dark:border-blue-800 rounded-full flex items-center justify-center mx-auto mb-6">
      ...
      {/* Trust Section */}
      <section className="bg-slate-900 dark:bg-slate-900 py-24 border-t border-slate-800 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              ...
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.1 }}
              viewport={{ once: true }}
              className="bg-slate-800/50 dark:bg-slate-800/50 rounded-xl p-8 text-center"
            >
              <div className="w-12 h-12 bg-blue-900/30 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-blue-400 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">TCPA Compliant</h3>
            ...
            <motion.div
              ...
              className="bg-slate-800/50 dark:bg-slate-800/50 rounded-xl p-8 text-center"
            >
              <div className="w-12 h-12 bg-green-900/30 dark:bg-green-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-green-400 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <motion.div
              ...
              className="bg-slate-800/50 dark:bg-slate-800/50 rounded-xl p-8 text-center"
            >
              <div className="w-12 h-12 bg-purple-900/30 dark:bg-purple-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-6 h-6 text-purple-400 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Instant Setup</h3>
              <p className="text-base text-slate-600 dark:text-slate-400">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-b from-slate-800 to-slate-950 dark:from-slate-800 dark:to-slate-950 py-24 border-t border-slate-800 dark:border-slate-800">
