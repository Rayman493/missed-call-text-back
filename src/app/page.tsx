                ...
                <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden">
                  ...
                  <div className="p-2.5 space-y-2">
                    <div className="flex gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="bg-blue-600 text-white text-xs rounded-2xl rounded-tl-sm px-2.5 py-1.5">
                    ...
                    <div className="flex gap-2">
                      <div className="flex-1 min-w-0 text-right">
                        <div className="bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-foreground text-xs rounded-2xl rounded-tr-sm px-2.5 py-1.5 inline-block text-left">
