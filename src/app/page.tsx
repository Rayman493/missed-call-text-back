    ...
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <section className="flex flex-col items-center justify-center px-4 py-20 md:py-32 text-center">
        ...
        <div className="mb-8 flex flex-col items-center gap-2">
          ...
          <span className="text-gray-700 dark:text-gray-300 text-lg">Only $49/month after trial</span>
          <span className="text-gray-500 dark:text-gray-400 text-sm">No contracts</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link
            href="/demo"
            className="px-8 py-4 bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-300 font-semibold rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-300 dark:hover:bg-gray-700 transition-colors"
          >
            View Demo
          </Link>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Missed call comes in</h3>
              <p className="text-gray-600 dark:text-gray-400">Customer calls your business but you can't answer</p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg className="w-10 h-10 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">ReplyFlow texts them instantly</h3>
              <p className="text-gray-600 dark:text-gray-400">Automatic personalized text response within seconds</p>
            </div>
            <div className="text-center">
              <div className="w-20 h-20 bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-6">
                <svg className="w-10 h-10 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-3">Lead captured</h3>
              <p className="text-gray-600 dark:text-gray-400">Customer appears in your dashboard ready to follow up</p>
            </div>
          </div>
        </div>
      </section>
