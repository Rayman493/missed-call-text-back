      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 md:py-20">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 md:gap-16">
          ...
          <div className="col-span-1 sm:col-span-2 md:col-span-2">
            ...
            <p className="text-muted-foreground mb-4 sm:mb-6 md:mb-8 max-w-md text-sm sm:text-base leading-relaxed">
          ...
          {/* Product */}
          <div>
            <h3 className="text-sm font-semibold text-foreground mb-4 sm:mb-6 md:mb-8">Product</h3>
          ...
          {/* Company */}
          <div>
            <h3 className="text-sm font-semibold text-foreground mb-4 sm:mb-6 md:mb-8">Company</h3>
            <ul className="space-y-3 sm:space-y-4">
              <li>
        ...
        {/* Bottom Section */}
        <div className="mt-8 sm:mt-12 md:mt-16 pt-6 sm:pt-8 border-t border-border">
...
export default async function Home() {
  ...
  return (
    <>
        ...
        <section className="relative flex flex-col items-center justify-center py-5 sm:py-6 md:py-20 text-center bg-gradient-to-br from-slate-50 via-white to-slate-50 dark:from-background dark:via-muted dark:to-background">
          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-2 sm:space-y-3 relative z-10">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-sm sm:text-base md:text-xl text-slate-700 dark:text-slate-300 max-w-2xl sm:max-w-3xl leading-relaxed mt-1.5 sm:mt-2">
              ...
              <div className="mt-2 sm:mt-3 flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4">
                ...
                <Link
                  ...
                  className="inline-flex items-center justify-center h-10 sm:h-12 px-4 sm:px-8 w-[260px] sm:w-auto sm:min-w-[240px] bg-blue-600 text-white font-bold text-sm sm:text-base rounded-xl shadow-lg hover:bg-blue-700 hover:shadow-xl transition-all duration-200 hover:scale-105"
                >
              ...
              <div className="mt-2 sm:mt-2 flex flex-col items-center gap-0.5">
                <span className="text-sm text-slate-700 dark:text-slate-400 font-medium">14-Day Free Trial</span>
                <span className="text-sm text-slate-700 dark:text-slate-400">$59/month after trial</span>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="hidden lg:flex items-center justify-between gap-4 max-w-5xl mx-auto">
              ...
              <div className="flex flex-col items-center text-center group min-h-[180px]">
                ...
                <p className="text-sm text-slate-700 dark:text-slate-400">Incoming call from potential customer</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group min-h-[180px]">
                ...
                <p className="text-sm text-slate-700 dark:text-slate-400">You can't answer the phone</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group min-h-[180px]">
                ...
                <p className="text-sm text-slate-700 dark:text-slate-400">AI collects caller details automatically</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group min-h-[180px]">
                ...
                <p className="text-sm text-slate-700 dark:text-slate-400">Instant text message sent to caller</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center group min-h-[180px]">
                ...
                <p className="text-sm text-slate-700 dark:text-slate-400">All information saved and ready for follow-up</p>
              </div>
            </div>
            ...
            <div className="lg:hidden space-y-2 max-w-md mx-auto">
              {/* Customer Calls */}
              <div className="flex items-center gap-2.5 bg-slate-50 dark:bg-slate-800/50 rounded-lg p-2.5 border border-slate-200 dark:border-slate-700">
              ...
              {/* Customer Receives Response */}
              <div className="flex items-center gap-2.5 bg-slate-50 dark:bg-slate-800/50 rounded-lg p-2.5 border border-slate-200 dark:border-slate-700">
                <div className="w-9 h-9 bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg className="w-4.5 h-4.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                  </svg>
                </div>
              ...
              {/* Lead Appears In Dashboard */}
              <div className="flex items-center gap-2.5 bg-slate-50 dark:bg-slate-800/50 rounded-lg p-2.5 border border-slate-200 dark:border-slate-700">
                <div className="w-9 h-9 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg flex items-center justify-center flex-shrink-0">
                  <svg className="w-4.5 h-4.5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                  </svg>
                </div>
      ...
      <HomepageErrorBoundary>
        <section className="bg-white dark:bg-background py-4 sm:py-5 md:py-6 border-t border-slate-200 dark:border-slate-800">
          <div className="max-w-4xl mx-auto px-6 lg:px-8">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4 sm:p-5 text-center">
              <h3 className="text-sm sm:text-base font-bold text-slate-900 dark:text-foreground mb-1.5 sm:mb-2">
                Two Ways ReplyFlow Captures Leads
              </h3>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-3 text-xs sm:text-sm text-slate-700 dark:text-slate-400">
      ...
      <HomepageErrorBoundary>
        <section className="bg-gradient-to-b from-slate-50 to-white dark:from-muted dark:to-background py-12 sm:py-16 md:py-20 border-t border-slate-200 dark:border-border">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl overflow-hidden border border-slate-200 dark:border-slate-700">
                ...
                <div className="p-3 sm:p-5 md:p-8 space-y-3 sm:space-y-4 md:space-y-6">
                  {/* Navigation Tabs */}
                  ...
                  <div className="space-y-2">
                    <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-2.5 sm:p-3">
                    ...
                    <div className="bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg p-3">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-sm text-slate-700 dark:text-slate-400">AC repair • Medium</div>
                        </div>
                        <div className="text-right">
                    ...
                    <div className="bg-white dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg p-3">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-sm text-slate-700 dark:text-slate-400">Plumbing estimate • Low</div>
                        </div>
                        <div className="text-right">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 rounded-xl p-4 sm:p-5 border border-blue-200 dark:border-blue-800 shadow-sm hover:shadow-md transition-shadow">
                  <div className="w-10 h-10 sm:w-11 sm:h-11 bg-blue-600 rounded-xl flex items-center justify-center mb-2 sm:mb-3 shadow-sm">
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                  </div>
                  <h3 className="font-semibold text-slate-900 dark:text-foreground mb-1.5 text-sm">Lead Management</h3>
                  <p className="text-xs text-slate-700 dark:text-slate-400 leading-relaxed">Track every lead with status updates and priority levels</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-900/20 dark:to-emerald-800/20 rounded-xl p-5 border border-emerald-200 dark:border-emerald-800 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-xs text-slate-700 dark:text-slate-400 leading-relaxed">All customer messages in one unified inbox</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-5 border border-purple-200 dark:border-purple-800 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-xs text-slate-700 dark:text-slate-400 leading-relaxed">See appointments, holidays, and events without leaving ReplyFlow</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-xl p-5 border border-orange-200 dark:border-orange-800 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <p className="text-xs text-slate-700 dark:text-slate-400 leading-relaxed">Review AI intake summaries and caller information</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Features Section */}
      <HomepageErrorBoundary>
        <section id="features-section" className="bg-gradient-to-b from-slate-50 to-white dark:from-muted dark:to-background py-10 sm:py-12 md:py-16 border-t border-slate-200 dark:border-border">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-10 md:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 dark:text-foreground mb-3 sm:mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-5 md:p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col">
                <div className="flex flex-col items-center text-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center mb-2 sm:mb-3">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-foreground">Keep Your Existing Number</h3>
                </div>
                <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-400 mb-3 sm:mb-4 text-center">
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-5 md:p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col">
                <div className="flex flex-col items-center text-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-100 dark:bg-emerald-900/30 rounded-lg flex items-center justify-center mb-2 sm:mb-3">
                  ...
                  <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-foreground">AI Voicemail Intake</h3>
                </div>
                <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-400 mb-3 sm:mb-4 text-center">
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-5 md:p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col">
                <div className="flex flex-col items-center text-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-purple-100 dark:bg-purple-900/30 rounded-lg flex items-center justify-center mb-2 sm:mb-3">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                    </svg>
                  </div>
                  <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-foreground">Instant Text-Back</h3>
                </div>
                <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-400 mb-3 sm:mb-4 text-center">
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-5 md:p-6 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col">
                <div className="flex flex-col items-center text-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-100 dark:bg-orange-900/30 rounded-lg flex items-center justify-center mb-2 sm:mb-3">
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-orange-600 dark:text-orange-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <h3 className="text-base sm:text-lg font-bold text-slate-900 dark:text-foreground">Google Calendar View</h3>
                </div>
                <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-400 mb-3 sm:mb-4 text-center">
      ...
      <HomepageErrorBoundary>
        <section className="bg-white dark:bg-background py-10 sm:py-12 md:py-16 border-t border-slate-200 dark:border-slate-800">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <div className="text-center mb-8 sm:mb-10 md:mb-12">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-slate-900 dark:text-foreground mb-3 sm:mb-4">
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 dark:text-slate-400">Keep the number your customers already know.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 dark:text-slate-400">Customers simply call your business as normal.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 dark:text-slate-400">Get started quickly with guided onboarding.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 dark:text-slate-400">Try ReplyFlow risk-free before subscribing.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 dark:text-slate-400">AI can collect caller information from voicemails when you're unavailable.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-700 dark:text-slate-400">Missed calls become organized leads automatically.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:hidden space-y-3">
              {/* Works with your existing phone number */}
              <div className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-4 sm:p-5 md:p-6 shadow-sm">
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                    <svg className="w-3 h-3 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  ...
                  <div>
                    <h3 className="font-semibold text-slate-900 dark:text-foreground mb-1 text-sm sm:text-base">Works with your existing phone number</h3>
                    <p className="text-xs sm:text-sm text-slate-700 dark:text-slate-400">Keep the number your customers already know.</p>
                  </div>
                </div>
              </div>
      ...
      {/* Final CTA Section */}
      <HomepageErrorBoundary>
        <section className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 py-16 sm:py-20 md:py-24 border-t border-blue-200 dark:border-blue-800">
          <div className="max-w-5xl mx-auto px-6 lg:px-8 text-center">
            <div>
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-slate-900 dark:text-foreground mb-5 sm:mb-6 md:mb-7">
                Recover Missed Leads Today
              </h2>
              <p className="text-lg sm:text-xl md:text-2xl text-slate-700 dark:text-muted-foreground mb-8 sm:mb-10 md:mb-12 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 md:gap-6">
                <Link
                  href="/auth?mode=signup"
                  className="h-12 sm:h-14 px-6 sm:px-8 bg-blue-600 text-white font-semibold rounded-xl shadow-lg hover:bg-blue-700 hover:shadow-xl transition-all duration-200 inline-flex items-center justify-center text-base sm:text-lg"
                >
                  Start Your 14-Day Free Trial
                </Link>
                <Link
                  href="/demo"
                  className="h-12 sm:h-14 px-6 sm:px-8 bg-white dark:bg-slate-800 text-blue-600 dark:text-blue-400 font-semibold rounded-xl shadow-lg hover:bg-slate-50 dark:hover:bg-slate-700 hover:shadow-xl transition-all duration-200 inline-flex items-center justify-center text-base sm:text-lg border border-blue-200 dark:border-blue-800"
                >
                  Watch Demo
                </Link>
              </div>
              
              <div className="mt-6 sm:mt-8 text-xs sm:text-sm text-slate-700 dark:text-slate-400">
