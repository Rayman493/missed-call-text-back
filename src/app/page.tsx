      ...
      <section className="bg-gradient-to-b from-slate-50 to-white dark:from-muted dark:to-background py-24 border-t border-slate-200 dark:border-border">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 relative">
            ...
            <div className="hidden md:block absolute top-1/2 left-[30%] transform -translate-x-1/2 -translate-y-[45%] text-slate-300 dark:text-slate-600 z-10">
              <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
            </div>
            {/* Arrow between step 2 and 3 (desktop) */}
            <div className="hidden md:block absolute top-1/2 left-[63%] transform -translate-x-1/2 -translate-y-[45%] text-slate-300 dark:text-slate-600 z-10">
              <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
            </div>
