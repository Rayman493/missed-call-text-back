    ...
    <main className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <section className="flex flex-col items-center justify-center px-4 py-20 md:py-32 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <Link
            href="/dashboard"
            className="px-8 py-4 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-semibold rounded-lg border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
          >
            View Dashboard Demo
          </Link>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Step 1</h3>
              <p className="text-gray-600 dark:text-gray-400">Customer calls your business</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-3xl">💬</span>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Step 2</h3>
              <p className="text-gray-600 dark:text-gray-400">We instantly text them back</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-3xl">💰</span>
              </div>
              <h3 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-2">Step 3</h3>
              <p className="text-gray-600 dark:text-gray-400">You turn missed calls into paying customers</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-lg p-6 md:p-8 max-w-md mx-auto">
