      ...
      <section className="bg-gradient-to-b from-slate-50 to-white dark:from-slate-800 dark:to-slate-950 py-24 border-t border-slate-200 dark:border-slate-800">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 text-center">
          ...
          >
            ...
            <Link
              href="/signup"
              className="h-12 px-8 bg-gradient-to-r from-blue-600 to-blue-500 text-white font-semibold rounded-xl shadow-sm hover:shadow-md hover:from-blue-500 hover:to-blue-400 transition-all hover:-translate-y-[1px] inline-flex items-center justify-center"
            >
