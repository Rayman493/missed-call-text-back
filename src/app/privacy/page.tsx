...
export const metadata: Metadata = {
  ...
  description: 'ReplyFlowHQ privacy policy for conversational missed-call response automation. How we protect customer and business data with enterprise-grade security.',
}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto">
              How ReplyFlowHQ protects customer and business information with enterprise-grade security and privacy standards.
            </p>
                  ...
                  <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">
                          <strong>Secure Infrastructure</strong> - Enterprise-grade hosting and monitoring
                        </p>
                      </div>
                      <div className="flex items-start gap-3">
                        <svg className="w-5 h-5 text-green-600 dark:text-green-400 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
