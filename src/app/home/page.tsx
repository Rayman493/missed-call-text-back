      ...
      <section className="bg-gradient-to-b from-slate-50 to-white dark:from-muted dark:to-background py-16 border-t border-slate-200 dark:border-border">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="hidden lg:flex items-center justify-between gap-4 max-w-5xl mx-auto">
            {/* Customer Calls - Keep this copy in sync with src/app/home/page.tsx and src/app/page.tsx. */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.1 }}
              viewport={{ once: true }}
              className="flex flex-col items-center text-center group min-h-[200px]"
            >
          ...
          <div className="lg:hidden space-y-4 max-w-md mx-auto">
            ...
            <motion.div
              ...
              transition={{ duration: 0.6, ease: "easeOut", delay: 0.1 }}
              viewport={{ once: true }}
              className="flex items-center gap-4 bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-200 dark:border-slate-700 min-h-[100px]"
            >
