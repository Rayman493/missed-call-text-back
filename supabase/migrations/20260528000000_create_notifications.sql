...
CREATE TABLE IF NOT EXISTS public.notifications (
  ...
  type TEXT NOT NULL CHECK (type IN ('new_lead', 'customer_reply', 'followup_completed', 'forwarding_disconnected', 'sms_failed', 'trial_ending', 'subscription_issue', 'voicemail_received')),
  title TEXT NOT NULL,
